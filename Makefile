#############################################################################
# Makefile for building: Hangman.app/Contents/MacOS/Hangman
# Generated by qmake (3.1) (Qt 6.6.2)
# Project:  Hangman.pro
# Template: app
# Command: /usr/local/opt/qt/bin/qmake -o Makefile Hangman.pro -spec macx-clang
#############################################################################
...
DISTDIR = /Users/paul/Downloads/hangman/Hangman/.tmp/Hangman1.0.0
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		Hangman.pro mainwindow.h \
		dataManager.h main.cpp \
		mainwindow.cpp \
		dataManager.cpp
QMAKE_TARGET  = Hangman
DESTDIR       = 
TARGET        = Hangman.app/Contents/MacOS/Hangman

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/paul/Downloads/hangman/Hangman/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/paul/Downloads/hangman/Hangman/Hangman.pro
...
Hangman.app/Contents/MacOS/Hangman: ui_mainwindow.h $(OBJECTS)  
	@test -d Hangman.app/Contents/MacOS/ || mkdir -p Hangman.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Hangman.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.6.2_1/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile Hangman.pro -spec macx-clang
...
Hangman.app/Contents/PkgInfo: 
	@test -d Hangman.app/Contents || mkdir -p Hangman.app/Contents
	@$(DEL_FILE) Hangman.app/Contents/PkgInfo
	@echo "APPL????" > Hangman.app/Contents/PkgInfo
Hangman.app/Contents/Info.plist: 
	@test -d Hangman.app/Contents || mkdir -p Hangman.app/Contents
	@$(DEL_FILE) Hangman.app/Contents/Info.plist
	@plutil -convert xml1 -o - /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,fr.paulgvs.Hangman,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},fr.paulgvs.Hangman,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Hangman,g" -e "s,@LIBRARY@,Hangman,g" -e "s,\$${EXECUTABLE_NAME},Hangman,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Hangman.app/Contents/Info.plist

all: Makefile \
		Hangman.app/Contents/PkgInfo \
		Hangman.app/Contents/Info.plist Hangman.app/Contents/MacOS/Hangman
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h dataManager.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp dataManager.cpp $(DISTDIR)/
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/usr/local/share/qt/libexec/moc $(DEFINES) --include /Users/paul/Downloads/hangman/Hangman/moc_predefs.h -I/usr/local/share/qt/mkspecs/macx-clang -I/Users/paul/Downloads/hangman/Hangman -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/usr/local/lib mainwindow.h -o moc_mainwindow.cpp
...
mainwindow.o: mainwindow.cpp dataManager.h \
		/usr/local/lib/QtWidgets.framework/Headers/QMainWindow \
		/usr/local/lib/QtWidgets.framework/Headers/qmainwindow.h \
		mainwindow.h \
		/usr/local/lib/QtWidgets.framework/Headers/QGraphicsScene \
